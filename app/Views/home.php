    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="welcomeTitle">Selamat Datang</h5>
                <!-- TOMBOL CLOSE -->
            ...
            <div class="modal-body text-start px-4 pb-4">
                <h5 class="fw-bold mb-2">TP PKK Kelurahan Lebak Denok</h5>
            ...
            <div class="modal-footer d-flex justify-content-between flex-wrap">
                <button type="button" class="btn btn-secondary rounded-pill py-2" data-dismiss="modal">Tutup</button>
                <a href="/program" class="btn btn-brand rounded-pill py-2">Lihat Program</a>
            </div>
        </div>
    </div>
</div>
