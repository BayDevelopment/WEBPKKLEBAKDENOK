...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 page-title mb-3"><i class="fa-solid fa-clipboard-check"></i> Tambah Quiz</h1>
        ...
        <div class="col-xl-9 col-lg-10">
            <div class="card card-modern position-relative">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h6 class="m-0 fw-bold">Form Tambah Quiz</h6>
                ...
                <div class="card-body p-4">
                    <form action="<?= site_url('admin/quiz/create'); ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <div class="mf-help">Contoh: “Quiz Matematika Dasar”.</div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="mf-help">Otomatis dari judul, bisa kamu ubah.</div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="mf-group">
                                    ...
                                    <select id="kategori" name="kategori"
                                        ...
                                        value="<?= old('kategori', $quiz['kategori'] ?? '') ?>">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="mf-help">Misal: 30, 45, 60.</div>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="mf-group">
                                    ...
                                    <select id="status" name="status"
                                        ...
                                        value="<?= old('status') ?? '' ?>">
                                        <option value="" hidden <?= old('status') ? '' : 'selected' ?>></option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_virtual_all"
                                        name="is_virtual_all" value="1" <?= old('is_virtual_all') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="is_virtual_all">
                                        <span class="mr-4 p-1"></span>Centang jika quiz bisa diikuti semua masyarakat
                                    </label>
                                </div>
                            ...
                            <!-- THUMBNAIL (pakai upload field punyamu) -->
                            <div class="col-md-6">
                                ...
                                <div class="preview-wrap">
                                    <img id="thumbPreview" src="https://placehold.co/320x160?text=Preview"
...
<script>
    ...
    if (judulEl && slugEl) {
        judulEl.addEventListener('input', () => {
            // Hanya update slug jika user belum mengedit slug secara manual
            if (!slugEl.dataset.touched) slugEl.value = slugify(judulEl.value);
        });
    ...
    if (thumbInput) {
        thumbInput.addEventListener('change', e => {
            ...
            rd.onload = ev => thumbPrev.src = ev.target.result;
            rd.readAsDataURL(f);
        });
    }
</script>
